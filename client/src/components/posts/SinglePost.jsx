    ...
    return (
      <div className="flex flex-col gap-2">
        <div className="flex justify-between items-center">
          <Link to={`/Profile/${post.postedBy._id}`} className="flex items-center gap-2">
              ...
              {post.comments.length === 1 ? (
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <div className="h-6 w-6 bg-black flex items-center justify-center text-white text-2xl font-bold rounded-full overflow-hidden">
